...
#SBATCH --job-name=run_npe_gowerstreet
...
python scripts/run_npe_budget_scan.py \
    --checkpoints_path=/home/noedia/links/scratch/wl_chall/gowerstreet/finetune/budget_scan_gowerstreet\
    --npe_results_path=/home/noedia/links/scratch/wl_chall/budget_scan_gowerstreet/npe_results\
